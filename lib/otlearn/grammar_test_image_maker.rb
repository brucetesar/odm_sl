...
module OTLearn
  ...
  class GrammarTestImageMaker
    ...
    def initialize(rcd_runner: nil, rcd_image_maker: nil,
                   lexicon_image_maker: nil, sheet_class: nil)
      ...
      @rcd_image_maker = rcd_image_maker || RcdImageMaker.new
      @lexicon_image_maker = lexicon_image_maker || LexiconImageMaker.new
      @sheet_class = sheet_class || Sheet
    end

    # Returns a sheet containing the image of _grammar_test_.
    # :call-seq:
    ...
    def get_image(grammar_test)
      ...
      lex_image =
        @lexicon_image_maker.get_image(grammar_test.grammar.lexicon)
      sheet.add_empty_row
