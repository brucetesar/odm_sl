...
RSpec.describe Cell do
  ...
  it 'is == a cell with the same row/col' do
    expect(@cell == described_class.new(2, 3)).to be true
  end

  it 'is eql? a cell with the same row/col' do
    expect(@cell.eql?(described_class.new(2, 3))).to be true
  end

  it 'is not == a cell with different row/col' do
    expect(@cell == described_class.new(2, 4)).to be false
  end

  it 'is not eql? a cell with different row/col' do
    expect(@cell.eql?(described_class.new(2, 4))).to be false
  end
end
