...
RSpec.describe 'OTGeneric::CandidateReader' do
  context 'given an array with three constraints' do
    ...
    context 'and a data row with two violation columns' do
    ...
    context 'and a data row with four violation columns' do
    ...
    context 'and a non-numeric violation count' do
