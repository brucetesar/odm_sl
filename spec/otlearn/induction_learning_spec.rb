...
RSpec.describe OTLearn::InductionLearning do
  ...
  context 'with no failed winner outputs' do
    ...
    it 'raises a RuntimeError' do
      expect do
        in_learner = described_class.new
  ...
  context 'with one inconsistent failed winner' do
    ...
    context 'when it allows a feature to be set' do
      before do
    ...
    context 'when it does not allow a feature to be set' do
      before do
  ...
  context 'with one consistent failed winner' do
    ...
    context 'when it allows new ranking information' do
      before do
