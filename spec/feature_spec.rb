...
RSpec.describe Feature do
  ...
  it 'is not val1' do
    expect(@host).not_to be_val1
  end

  it 'is not val2' do
    expect(@host).not_to be_val2
  end
  ...
  context 'when value is set to val1' do
    ...
    it 'is not unset' do
      expect(@host).not_to be_unset
    end

    context 'when it is then unset' do
      before do
        @host.unset
      end
  ...
  context 'with another feature of same type and value' do
  ...
  context 'with another feature with a different value' do
    let(:feature2) { double('feature 2') }
